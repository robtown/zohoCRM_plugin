 ...
 */
 jQuery(document).ready(function($) {
	...
	if ( ghjb_json && $('.zohoCRM').length ){
		console.log(ghjb_json);
		if (ghjb_d) { console.log('job board loading', ghjb_json); }
		$('.zohoCRM').each( function(){
			zohoCRM_jobs( ghjb_json, '#' + $(this).attr('id') );
		});
	} else {
	...
	$('.zohoCRM[data-type="accordion"] .jobs').on('click', '.job_read_full', function(e){
		e.preventDefault();
		//get ghjb id
		var this_id = '#' + $(this).parents('.zohoCRM').attr('id');
	...
	$('.zohoCRM').on('click', '.job_apply', function(e){
		//get ghjb id
		var this_id = '#' + $(this).parents('.zohoCRM').attr('id');
	...
	function thanks_message(formid, textStatus){
		...
		//get ghjb id
		var this_id = '#' + $(formid).parents('.zohoCRM').attr('id');
	...
	function jobs_scroll_top(this_caller){
		//get ghjb id
		var this_id = '#' + $(this_caller).parents('.zohoCRM').attr('id');
		// if (ghjb_d) { console.log(this_id); }
...
function zohoCRM_jobs(json, jbid){
